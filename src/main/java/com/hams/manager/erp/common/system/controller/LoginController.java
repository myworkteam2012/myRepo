package com.hams.manager.erp.common.system.controller;

import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.hams.manager.erp.common.annotation.SysLog;
import com.hams.manager.erp.common.base.BaseController;
import com.hams.manager.erp.common.base.MySysUser;
import com.hams.manager.erp.common.entity.Menu;
import com.hams.manager.erp.common.entity.User;
import com.hams.manager.erp.common.util.Constants;
import com.hams.manager.erp.common.util.RestResponse;
import com.hams.manager.erp.common.util.VerifyCodeUtil;
...
public class LoginController extends BaseController {
	...
	public String main(Model model){
		...
		Set<com.hams.manager.erp.common.entity.Menu> menus = user.getMenus();
		java.util.List<com.hams.manager.erp.common.entity.Menu> showMenus = Lists.newArrayList();
		if(menus != null && menus.size()>0){
			for (com.hams.manager.erp.common.entity.Menu menu : menus){
...
class MenuComparator implements Comparator<com.hams.manager.erp.common.entity.Menu>{

	@Override
	public int compare(com.hams.manager.erp.common.entity.Menu o1, Menu o2) {
